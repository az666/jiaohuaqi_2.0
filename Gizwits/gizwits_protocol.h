...
* @{
*/
#define PRODUCT_KEY "a58f738843964c54a62e9f3304145639"
/**@} */
/**@name Product Secret  
* @{
*/
#define PRODUCT_SECRET "661d9055d753430a94197bf03e27900c"
...
* @{
*/
#define H_1_BYTEOFFSET                    0
#define H_1_BITOFFSET                     0
#define H_1_LEN                           1
#define H_2_BYTEOFFSET                    0
#define H_2_BITOFFSET                     1
#define H_2_LEN                           1
#define H_3_BYTEOFFSET                    0
#define H_3_BITOFFSET                     2
#define H_3_LEN                           1
#define KG_1_BYTEOFFSET                    0
#define KG_1_BITOFFSET                     3
#define KG_1_LEN                           1
#define KG_2_BYTEOFFSET                    0
#define KG_2_BITOFFSET                     4
#define KG_2_LEN                           1
#define KG_3_BYTEOFFSET                    0
#define KG_3_BITOFFSET                     5
#define KG_3_LEN                           1
#define KG_4_BYTEOFFSET                    0
#define KG_4_BITOFFSET                     6
#define KG_4_LEN                           1
#define KG_5_BYTEOFFSET                    0
#define KG_5_BITOFFSET                     7
#define KG_5_LEN                           1

#define HT_FZ_RATIO                         1
#define HT_FZ_ADDITION                      0
#define HT_FZ_MIN                           0
#define HT_FZ_MAX                           100
#define H1_ht_RATIO                         1
#define H1_ht_ADDITION                      0
#define H1_ht_MIN                           0
#define H1_ht_MAX                           100
#define H2_ht_RATIO                         1
#define H2_ht_ADDITION                      0
#define H2_ht_MIN                           0
#define H2_ht_MAX                           100
#define H3_ht_RATIO                         1
#define H3_ht_ADDITION                      0
#define H3_ht_MIN                           0
#define H3_ht_MAX                           100
#define MR_FZ_RATIO                         1
#define MR_FZ_ADDITION                      0
#define MR_FZ_MIN                           0
#define MR_FZ_MAX                           100
/**@} */
